...
<?php
echo '<div class="Info">', sprintf(T('This page is only for Vanilla 2 addons.', 'This page is only for adding Vanilla 2 addons. If you want to add a Vanilla 1 addon click <a href="%s">here</a>.'), Url('/addon/addv1')), '</div>';
