...
class SEOCompanion extends Gdn_Plugin{
  ...
  public function Base_Render_Before(&$Sender)
  {
  		...
  		$DefaultDescription= "Custom corporate or small business gift tins and gourmet treats."; // Default Meta Description
  		$DefaultTags = "custom tins containers snack candy cookie nut corporate business gift present holiday seasonal"; // Default list of tags, blank space separated.
